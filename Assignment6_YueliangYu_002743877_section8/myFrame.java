...
public class myFrame extends JFrame {
    ...
    public static void placeComponents(JPanel panel) {
        ...
        panel.add(label1);
        label2.setBounds(10,50,170,25);
        panel.add(label2);
        label3.setBounds(10,80,170,25);
        panel.add(label3);
        label4.setBounds(10,110,170,25);
        panel.add(label4);
        /*
        ...
        textField1.setBounds(175,20,165,25);
        panel.add(textField1);
        textField2.setBounds(175,50,165,25);
        panel.add(textField2);
        textField3.setBounds(175,80,165,25);
        panel.add(textField3);
        textField4.setBounds(175,110,165,25);
        panel.add(textField4);

        JButton DButton = new JButton("Click to calcuate Score");
        DButton.setBounds(335, 80, 200, 25);
